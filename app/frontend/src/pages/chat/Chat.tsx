...
import novablack from "../../assets/nova-logo-black.png";
...
const Chat = () => {
    ...
    const [userPersona, setUserPersona] = useState<string>("expert");
    const [systemPersona, setSystemPersona] = useState<string>("I am an Howden trained chatbot helping colleagues getting the most information of our internal documents.");
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img className={styles.chatEmptyStateLogo} src={novablack} alt="Logo" />
                            <h1 className={styles.chatEmptyStateTitle}>Ask Nova</h1>
                            <p className={styles.chatEmptyStateDescription}>
                                Ask Nova a question and get an answer.
                            </p>
                        </div>
                    ) : (
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. How did global natural catastrophies impact reinsurance rates?)"
                            disabled={isLoading}
