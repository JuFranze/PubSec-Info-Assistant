...
import logocaha from "../../assets/Logo-caha.jpg";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                             <img className={styles.chatEmptyStateLogo} src={logocaha} alt="Logo" />
                            <h1 className={styles.chatEmptyStateTitle}>Ask Caha</h1>
                            <p className={styles.chatEmptyStateDescription}>
                                Ask Caha a question and get an answer.
                            </p>
                        </div>
                    ) : (
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. What does the red gas station icon mean?)"
                            disabled={isLoading}
